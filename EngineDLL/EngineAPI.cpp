...
#ifndef DIEAPI
#define DIEAPI extern "C" __declspec(dllexport)
#endif // !DIEAPI
...
namespace {
	...
	struct transform_component 
	{
		...
		transform::init_info to_init_info() 
		{
			...
			XMFLOAT4A rot_quad{};
			XMStoreFloat4A(&rot_quad, quat);
			memcpy(&info.rotation[0], &rot_quad.x, sizeof(f32) * _countof(info.rotation));
			return info;
		}
	};
}
...
DIEAPI id::id_type CreateGameEntity(game_entity_descriptor* e) {
	assert(e);
...
DIEAPI void RemoveGameEntity(id::id_type id) {
